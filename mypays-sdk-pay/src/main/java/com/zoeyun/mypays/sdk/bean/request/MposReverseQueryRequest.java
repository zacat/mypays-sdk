 ...
 * </pre>
 *
 * @author <a href="http://docs.mypays.cn/docs/hxtc-faas/mpos-reverse-query">SinMax</a>
 */
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class MposReverseQueryRequest extends BaseMypaysRequest {
    ...
    protected void storeMap(Map<String, String> map) {
        map.put("reverseOrderId", reverseOrderId);
    }
}
