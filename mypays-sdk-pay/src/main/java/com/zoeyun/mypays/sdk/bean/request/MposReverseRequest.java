 ...
 * </pre>
 *
 * @author <a href="http://docs.mypays.cn/docs/hxtc-faas/mpos-reverse">SinMax</a>
 */
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class MposReverseRequest extends BaseMypaysRequest {
    ...
    protected void checkConstraints() throws MypaysException {
        ...
        if (reverseAmount.compareTo(0) == 0) {
            throw new MypaysException("撤消金额不能为空或为0");
        }
    }
    ...
    protected void storeMap(Map<String, String> map) {
        ...
        map.put("reverseAmount", String.valueOf(reverseAmount));
    }
}
